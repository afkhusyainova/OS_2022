...
author: "Хусяинова Адиля Фаитовна"
...
![Программа 1](image/5.png){ #fig:005 width=70% }
...
![Программа 2, командный файл](image/7.png){ #fig:007 width=70% }
...
![Программа 3, командный файл](image/10.png){ #fig:0010 width=70% }
...
![Выполнение](image/11.png){ #fig:0011 width=70% }
