...
![Архив bzip2](image/3.png){ #fig:003 width=70% }
...
![Создание файла](image/10.png){ #fig:0010 width=70% }
...
![Программа](image/11.png){ #fig:0011 width=70% }
...
![Запуск файла](image/15.png){ #fig:0015 width=70% }
