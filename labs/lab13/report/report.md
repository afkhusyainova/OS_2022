...
![Исправленный Makefile](image/8.png){ #fig:008 width=70% }
...
![Numeral](image/18.png){ #fig:0018 width=70% }
...
![Splint calculate.c , splint main.c](image/21.png){ #fig:0021 width=70% }
